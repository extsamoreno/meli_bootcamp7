...
public class ObtenerDiplomaControllerTests {
    ...
    public void should_return_a_certificate_successfully() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/analyzeScores/{studentId}", studentId))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("message").value("El alumno Juan ha obtenido un promedio de 9.00. Puedes mejorar."))
    ...
    public void should_return_a_certificate_congrats_successfully() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/analyzeScores/{studentId}", studentId))
                .andDo(print())
                .andExpect(content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.jsonPath("message").value("El alumno Juan ha obtenido un promedio de 9.50. Felicitaciones!"))
