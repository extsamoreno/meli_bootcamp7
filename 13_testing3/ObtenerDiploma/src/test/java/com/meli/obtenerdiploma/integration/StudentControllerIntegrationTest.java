...
public class StudentControllerIntegrationTest {
    ...
    public void getStudentHappyPath() throws Exception {
        ...
        MvcResult response = this.mockMvc.perform(MockMvcRequestBuilders.get("/student/getStudent/{id}", 9999))
                .andDo(print()).andExpect(status().isOk())
    ...
    public void removeStudentHappyPath() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/student/removeStudent/{id}", 9999))
                .andDo(print()).andExpect(status().isOk());
    }
    ...
    public void removeStudentNonExistingId() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/student/removeStudent/{id}", 8888))
                .andDo(print()).andExpect(status().isOk());
    }
