...
public class AnalyzeNotesRestController {
  ...
  public ResponseEntity<CertificateDTO>  analyzeNotes(@Valid @RequestBody StudentDTO student){
    return new ResponseEntity<>(certificateService.analyzeNotes(student),HttpStatus.OK);
  }
