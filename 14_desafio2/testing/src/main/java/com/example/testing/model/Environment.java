...
public class Environment {
    ...
    @NotNull(message = "Environment price cannot be void.")
    @DecimalMax(value = "25.0", message = "Environment price cannot be over 25 mts.")
    private Double width;

    @NotNull(message = "Environment price cannot be void.")
    @DecimalMax(value = "33.0", message = "Environment price cannot be over 33 mts.")
