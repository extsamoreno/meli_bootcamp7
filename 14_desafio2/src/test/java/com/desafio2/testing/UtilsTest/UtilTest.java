package com.desafio2.testing.UtilsTest;
...
public class UtilTest {
    ...
    public static PropertyM2DTO createPropiedadM2DTO() {
        return new PropertyM2DTO("Libertador 5", 51.44);
    }

    //Devuelve DTO del ambiente mas grande de "Libertador 5"
    public static RoomDTO createAmbienteMayorDTO() {
        return new RoomDTO("Cocina", 17);
    }
    ...
    public static PropiedadRequestDTO crearPropiedadRequestDTO() {
        ...
        ArrayList<RoomRequestDTO> ambienteReqDTOS = new ArrayList<RoomRequestDTO>() {{
            add(cocina1);
            add(ba1);
            add(d1);
            add(d2);
