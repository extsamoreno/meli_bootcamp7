...
public class GetBiggestEnvironmentTest {
    ...
    public void HappyPath() throws Exception {
        PropertyBiggestEnvironmentDTO property = UtilGenerator.propertyBiggestEnvironmentHappy("Departamento1");
        ...
        MvcResult mvcResult =
                this.mockMvc.perform(MockMvcRequestBuilders.get("/properties/biggestenvironment/{id}",1))
