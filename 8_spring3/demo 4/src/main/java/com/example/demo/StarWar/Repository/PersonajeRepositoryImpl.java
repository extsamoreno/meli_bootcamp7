...
public class PersonajeRepositoryImpl implements PersonajeRepository{
    ...
    public List<Personaje> loadDataBase(){
        File file = null;
        try{
            file = ResourceUtils.getFile("/Users/ctaeger/Desktop/RepoBootcampTaeger-Camila/meli_bootcamp7/8_spring3/demo 4/src/main/java/com/example/demo/StarWar/Repository/starwars.json");
