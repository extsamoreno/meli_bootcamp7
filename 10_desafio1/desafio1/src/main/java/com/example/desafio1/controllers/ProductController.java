...
public class ProductController {
    ...
    public String generateNewPost(@RequestBody PostDTO post) throws PostAlreadyExistsException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public String generateNewPromoPost(@RequestBody PostPromoDTO post) throws PostAlreadyExistsException {
        iProductService.processNewPost(post);
