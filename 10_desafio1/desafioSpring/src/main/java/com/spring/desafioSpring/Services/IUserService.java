...
public interface IUserService {
    ...
    FollowersUserDTO followersByUser(int userId, String order) throws UserNotFoundException;
    FollowedUserDTO followedByUser(int userId, String order) throws UserNotFoundException;
