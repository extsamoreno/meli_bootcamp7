...
import com.desafio.socialMeli.model.service.helpers.DateToString;
    ...
    * */
    ...
    public List <PostDTO> orderPostByDate(List<PostDTO> postDTOS, String order){
        ...
        if (order.equals("date_asc_2W")) {
            ...
            Date dateBeforeTwoWeeks = DateHelper.getDateBeforeTwoWeeks();
            ...
            for(int i = 0; i<datesAux.size();i++)
                stringArrayListAux.add(DateToString.dateToString(datesAux.get(i)));
