...
-- 6.Mostrar el nombre y apellido de los actores cuyo 
-- rating sea mayor a 7.5.
SELECT first_name, last_name
FROM actors
WHERE rating > 7.5;
 
-- 7.Mostrar el título de las películas, el rating y los premios 
...
-- 8.Mostrar el título de las películas y el rating ordenadas 
...
-- 12.Listar los primeros 10 actores
SELECT first_name, last_name
FROM actors
LIMIT 10;
...
-- 15. Mostrar el título y rating de todas las 
...
-- 17.Mostrar el título de las películas que 
-- salieron entre el 2004 y 2008.
SELECT title
FROM movies
WHERE release_date BETWEEN '2004-01-01' AND '2008-12-31';

-- 18. Traer el título de las películas con el rating mayor a 3,
