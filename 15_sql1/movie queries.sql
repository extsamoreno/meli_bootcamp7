...
# No hay nada asi en la base de datos.
...
SELECT title
FROM movies
WHERE release_date BETWEEN CAST('2004-01-01' AS DATETIME) AND CAST('2008-12-31' AS DATETIME);
...
WHERE 	rating > 3 AND 
		awards > 1 AND
		release_date BETWEEN CAST('1988-01-01' AS DATETIME) AND CAST('2009-12-31' AS DATETIME);
