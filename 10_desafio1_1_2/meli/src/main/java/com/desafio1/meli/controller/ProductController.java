...
public class ProductController{
    ...
    public ResponseEntity<RequestFollowedProductList> getFollowedList(@PathVariable Integer userId, @RequestParam(required = false) PublicationOrderType order) throws NotExistUser {
     ...
     *
     * @param userId
     * @return Count promo by User
     * @throws NotExistUser
     */
    @GetMapping("/{userId}/countPromo/")
    public ResponseEntity<RequestFollowedProductList> getPromo(@PathVariable Integer userId) throws NotExistUser {
        return new ResponseEntity<RequestFollowedProductList>(iProductservice.listProductPromo(userId), HttpStatus.OK);
    }
}
