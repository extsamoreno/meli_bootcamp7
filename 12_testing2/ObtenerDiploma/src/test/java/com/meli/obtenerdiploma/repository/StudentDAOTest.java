...
public class StudentDAOTest {
    ...
    public void findById() {
        StudentDTO studentDTO = this.students.stream().filter(s -> s.getId().equals(1L))
                .findFirst().orElseThrow(() -> new StudentNotFoundException(1L));
        assertEquals(studentDTO.getStudentName(), studentDAO.findById(1L).getStudentName());
    }
