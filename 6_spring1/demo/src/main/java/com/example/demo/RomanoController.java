...
public class RomanoController {
    ...
    @GetMapping("/romano/{number}") // si no le puedo poner name al parametro, uso id, y después de pathvar pongo ("id")
    public String getRomano(@PathVariable Integer number) {
